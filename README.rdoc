...
* *distortion* - handles the complexity of the image. The :distortion can be set to 'low', 'medium', 'high' or 'none'. Default is 'low'.
...
Create "rails_root/config/initializers/simple_captcha.rb"
  ...
  SimpleCaptcha.setup do |sc|
    ...
    # default: low
    # possible values: 'low', 'medium', 'high', 'random', 'none'
